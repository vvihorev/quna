...
class WebPlug:
    ...
    def wait_for_element(self, by, query):
        timeout = 7
        try:
            element_present = expected_conditions.presence_of_element_located((by, query))
    ...
    def get_last_message_text(self) -> str:
        ...
        self.wait_for_element(By.XPATH, "//div[contains(@class, 'comment_message__text')]")
        messages = self.driver.find_elements(By.XPATH, "//div[contains(@class, 'comment_message__text')]")
    ...
    def custom_answer(self) -> None:
        ...
        # TODO: add this question to the FAQ
        self.driver.find_element(By.CLASS_NAME, "auto-textarea-input").send_keys(answer)
    ...
    def send_and_close_answer(self) -> None:
        ...
        self.driver.find_element(By.XPATH, "//*[contains(text(), 'Отправить и закрыть')]").click()
